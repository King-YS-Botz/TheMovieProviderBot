...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002083054563') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002104772532') # request channel id ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/YS_BOTZ_UPDATE/11') # How to open tutorial link for verification
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002083137744')).split()]
...
URL = "https://anymoviebot-8bcdb2784654.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://anymoviebot-8bcdb2784654.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://anymoviebot-8bcdb2784654.herokuapp.com/".format(FQDN)
else:
    URL = "https://anymoviebot-8bcdb2784654.herokuapp.com/".format(FQDN)
